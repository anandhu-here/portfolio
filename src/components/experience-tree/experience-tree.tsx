...
import { circadacareResponsibilities, nutritionIntegratedResponsibilities } from "./responsibilities";
  ...
  return (
    <div className="relative flex flex-col gap-4">
      ...
      <ExperienceCard
        ...
        companyName="Nutrition Integrated"
        startDate="Sept 2022"
        endDate="Oct 2023"
        responsibilities={nutritionIntegratedResponsibilities}
      />
    </div>
  );
};
